...
import com.weikun.model.ProfileExample.Criteria;
import com.weikun.model.ProfileExample.Criterion;
...
public class ProfileSqlProvider {
    ...
    protected void applyWhere(SQL sql, ProfileExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
